...
-- Dumping structure for table caketest.ChatMessages
CREATE TABLE IF NOT EXISTS `ChatMessages` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `from_user` int(11) NOT NULL DEFAULT '0',
  `to_user` int(11) NOT NULL DEFAULT '0',
  `is_type` varchar(50) NOT NULL DEFAULT '0',
  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table caketest.ChatMessages: ~0 rows (approximately)
...
-- Dumping data for table caketest.users: ~3 rows (approximately)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `first_name`, `last_name`, `username`, `password`, `email`, `login_status`, `created`, `modified`) VALUES
	(3, NULL, NULL, 'user3', '$2y$10$AoETBbuXLOcbFiyQkRY2YuwaUECK3EnZGrYAgp1nfw2w1z.UyChEm', NULL, 1, '2020-03-14 13:45:41', '2020-03-14 16:33:08'),
	(4, NULL, NULL, 'demouser', '$2y$10$7QMLN9QRleuKi0svlRZH0eFRko7eSp1sYRTdonwvC2ddZBbDoIVpm', NULL, 1, '2020-03-14 13:54:50', '2020-03-14 16:53:30'),
	(5, NULL, NULL, 'user4', '$2y$10$PDwqAEDlNA4PFpiuAu2gvet3wuPLOVMcSG0EkuhL4631oVGEML33G', NULL, 1, '2020-03-14 16:45:08', '2020-03-14 18:22:50');
